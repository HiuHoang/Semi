                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ asset('images/products/' .$value->productimage) }}">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="img/icon/heart.png" alt=""></a><span>Like</span></a></li>
                                        <li><a href="#"><img src="img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                        <li><a href="{{route('shopdetail', $value->product_id)}}"><img src="img/icon/search.png" alt=""><span>View</span></a></></li>
                                    </ul>
                                </div>
