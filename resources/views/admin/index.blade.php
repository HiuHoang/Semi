...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{url('')}}">SEMI PROJECT</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="{{route('insert')}}">Insert Product</a>
                                    <a class="nav-link" href="{{route('manage')}}"> Manage User</a>
                                </nav>
                            </div>
                        </div>
                    </div>
...
{{-- Footer --}}
        ...
        <script src="{{url('../public/admin')}}/js/datatables-simple-demo.js"></script>
    </body>
</html>
